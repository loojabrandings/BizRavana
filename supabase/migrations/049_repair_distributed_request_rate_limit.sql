-- =============================================
-- BizRavana - Repair request limiter variable resolution
-- Migration 049
-- =============================================

-- Migration 048 used a PL/pgSQL variable named current_time. PostgreSQL could
-- resolve that identifier as the SQL CURRENT_TIME value inside the upsert,
-- producing a time-with-time-zone value where a timestamptz was required.
