...
export function DentalHero({ onOpenBooking }: DentalHeroProps) {
  return (
    ...
    >
      {/* ── Mobile-Only Visual: Large Screen-Filling Crystal Tooth Experience (< lg) ── */}
      <div className="lg:hidden absolute top-[10%] sm:top-[8%] -right-10 sm:-right-6 w-[360px] sm:w-[460px] aspect-[1024/1536] pointer-events-none z-10 flex items-center justify-center">
      ...
      {/* ── Main Hero Content (Bottom-aligned, Clean High-Contrast Layer) ── */}
      <div className="relative w-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 pb-8 sm:pb-12 lg:pb-16 z-20 shrink-0">
        <div className="flex flex-col items-start gap-3 sm:gap-4 lg:gap-6 max-w-[680px]">
          
          {/* Location Badge */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-emerald-50/90 backdrop-blur-md border border-emerald-200/80 text-[11px] sm:text-xs font-bold text-[#05c989] tracking-wide shadow-xs">
          ...
          <h1 className="font-bold tracking-[-0.035em] text-[#111827] text-[34px] leading-[1.04] sm:text-[50px] sm:leading-[1.02] md:text-[68px] md:leading-[0.98] lg:text-[88px] lg:leading-[0.96] xl:text-[98px] xl:leading-[0.94]">
            <span className="block text-[#111827]">Gentle, Modern</span>
          ...
          <p className="text-slate-600 text-xs sm:text-sm lg:text-[15px] leading-relaxed font-normal max-w-[440px]">
          ...
          <div className="flex flex-row items-center gap-3 w-full sm:w-auto pt-1 sm:pt-0">
            <button
