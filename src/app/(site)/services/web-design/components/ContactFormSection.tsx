        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-6 flex flex-col justify-between h-full space-y-8">
              ...
              <div className="space-y-3 pt-2">
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-[22px] bg-[#0C0C0C] border-2 border-[#D7E2EA]/30 hover:border-white transition-all duration-300 group max-w-md cursor-pointer hover:-translate-y-1.5 shadow-[0_15px_30px_rgba(0,0,0,0.8)]"
                >
                  <div className="w-11 h-11 rounded-xl bg-emerald-500/20 border border-emerald-500/30 text-[#25D366] flex items-center justify-center group-hover:scale-110 transition-all duration-300 flex-shrink-0">
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-[22px] bg-[#0C0C0C] border-2 border-[#D7E2EA]/30 hover:border-white transition-all duration-300 group max-w-md cursor-pointer hover:-translate-y-1.5 shadow-[0_15px_30px_rgba(0,0,0,0.8)]"
                >
                  <div className="w-11 h-11 rounded-xl bg-white/[0.06] flex items-center justify-center text-white group-hover:scale-110 transition-all duration-300 flex-shrink-0">
            ...
            <div className="lg:col-span-6">
              <div className="bg-[#0C0C0C] rounded-[32px] sm:rounded-[40px] p-8 sm:p-10 border-2 border-[#D7E2EA]/30 hover:border-white transition-all duration-300 shadow-[0_25px_60px_rgba(0,0,0,0.85)]">
