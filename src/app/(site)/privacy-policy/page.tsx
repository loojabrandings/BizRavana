...
export const metadata: Metadata = {
  title: "Privacy Policy — BizRavana",
  description:
    "How BizRavana collects, uses, stores, shares, and protects your personal and business information.",
};
...
export default function PrivacyPolicyPage() {
  return (
    <main>
      ...
      <section className="feat-hero" aria-labelledby="privacy-hero-heading">
        <div className="feat-hero__inner">
          <Reveal>
            <p className="about-eyebrow">Legal</p>
            <h1 id="privacy-hero-heading" className="feat-hero__title">
              Privacy Policy
            </h1>
      ...
      <section className="about-section" aria-label="Privacy policy">
