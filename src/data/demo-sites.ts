...
export const DEMO_SITES: DemoSite[] = [
  {
    ...
    status: 'ready',
    features: [
      'Interactive Optical Unblur Reveal Lens Hero (400x200 Architecture)',
      'Dual-Layer Real-Time Optical Magnifier & Synchronized State Engine',
      'Editorial Bespoke Eyewear Gallery with Extreme Macro Close-Up Imagery',
      'Clinical Diagnostic Services Grid with LKR Pricing & Doctor Consultations',
      'SLMC-Registered Sri Lankan Doctor Roster (Colombo 07, Kandy, Galle)',
      'Infinite Auto-Moving Patient Reviews Marquee & WhatsApp Integration',
      'Lightning-Fast 0ms Single-Icon Dark/Light Theme Engine & Mobile Nav Drawer',
    ],
  },
  {
    id: 'demo-drink',
    ...
    status: 'ready',
    features: [
      '3D Interactive Tabletop Carousel with 4 Harvest Signatures',
      'Horizontal Expanding Interactive Flavor Lineup Accordion',
      'Side-by-Side Clean vs Conventional Comparison Matrix',
      '4-Step Orchard-to-Can Craft Process & Discovery Starter Pack',
    ],
  },
  {
    id: 'demo-kinetic-gym',
  ...
  },
  {
    ...
    categoryLabel: 'Event Planner',
    title: 'ZEE EVENTS',
    tagline: 'Curating extraordinary celebrations, bespoke weddings, and signature corporate experiences with timeless artistry and flawless precision',
    thumbnailUrl: '/demos/zee-events/card-preview.jpg',
    liveUrl: '/portfolio/zee-events',
    accentColor: '#2E7D32',
    status: 'ready',
    features: [
      'Cinematic Scroll Hero with 3D Layered Parallax Architecture',
      'Interactive Services Slider with 4 Signature Categories',
      'Sticky Stacking Portfolio Cards with Category Filtering',
      '4-Step Animated Planning Process Section',
      'Why Choose Us Grid with 6 Feature Highlights',
      'Editorial Footer with Social Image Grid',
    ],
  },
];
