...
/**
 * Site footer — five columns: brand block plus four link groups. Matches the
 * page background so it reads as part of the page (the closing CTA keeps its
 * inverted panel above). Shared by the landing page and the About page.
 */
export default function Footer() {
  return (
    <footer className="footer">
      <div className="footer__inner">
        <div className="footer__brand">
          ...
          <p className="footer__line">
            All-in-one business management for growing Sri Lankan businesses.
          </p>
              ...
              {col.links.map(({ label, href }) => (
                <li key={label}>
                  {href ? (
                    ...
                    <span className="footer__link">{label}</span>
                  )}
                </li>
              ))}
            </ul>
      ...
      <p className="footer__bar">© 2026 BizRavana. All rights reserved.</p>
    </footer>
  );
}
