...
import { OrderFormReviewStep } from "./order-form-review-step";
import type {
  OrderFormData,
  OrderFormLineItem,
  OrderFormCalculations,
} from "./types";
...
interface OrderFormWizardProps {
  ...
  handleAddItem: () => void;
  handleUpdateItem: (index: number, updates: Partial<OrderFormLineItem>) => void;
...
function ProgressIndicator({
  ...
  return (
    <nav aria-label="Order form steps" className="px-4 pt-4 pb-2">
...
export function OrderFormWizard({
  ...
  // The global mobile bottom nav is ~64px, plus safe-area-inset-bottom
  // If wizard is full-screen, this may not apply. Using a safe default.
        ...
        <div className="flex items-start justify-between px-4 pt-4 pb-2">
          <div className="min-w-0 flex-1">
            <h1 className="text-lg font-semibold tracking-tight">
              {isEditing ? "Edit Order" : "New Order"}: #{form.order_number}
            </h1>
