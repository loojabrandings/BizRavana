...
interface QuotationCustomerSectionProps {
  ...
  /** Optional courier-synced states/districts */
  courierStates?: CourierState[];
  /** Optional courier-synced cities */
  ...
  return (
    <>
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          placeholder="General quotation remarks, delivery instructions, etc."
          value={form.remarks}
          ...
          <div className="px-6 pt-6 pb-5">
            ...
            <div className="mt-3 flex items-start gap-2.5 rounded-lg border border-warning/20 bg-warning/[0.06] px-3.5 py-2.5">
              ...
              <p className="text-xs text-muted-foreground/80 leading-relaxed">
                ...
                review all filled fields carefully before creating the quotation.
              </p>
            </div>
          </div>
