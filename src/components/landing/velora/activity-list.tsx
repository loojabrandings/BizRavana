...
const notifications = [
  {
    ...
    title: "New sale",
    description: "BizRavana Pro — Lifetime license",
    time: "just now",
  },
  {
    icon: UserPlusIcon,
    ...
    title: "New signup",
    description: "tharindu@example.com joined",
    time: "2m ago",
  },
  {
    icon: StarIcon,
    ...
    title: "GitHub star",
    description: "bizravana hit 500 stars",
    time: "5m ago",
  },
  {
    ...
    title: "New review",
    description: '"Best business dashboard I\'ve used"',
    time: "12m ago",
  },
  {
    icon: TrendingUpIcon,
    ...
    title: "Traffic spike",
    description: "+248% organic growth this month",
    time: "18m ago",
  },
  {
    ...
    description: "app.bizravana.com — production",
    time: "24m ago",
  },
];
